...
const customerSchema = z.object({
  ...
  dateOfBirth: z
    ...
    .refine((val) => {
      ...
      // Adjust age if DOB month/day is after today month/day
...
const categories = [
  'Healthcare', 'Technology', 'Education', 'Finance', 'Marketing', 'Legal'
];

// Static country options with flags
const countries = [
...
export default function AddCustomerForm() {
  ...
  const {
    ...
    resolver: zodResolver(customerSchema), // Use Zod for validation
    defaultValues: {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center">
        <h1 className="text-2xl font-medium text-gray-900">Add Customer</h1>
      </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} noValidate className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div>
              ...
              <select {...register('country')} id="country" className="form-select text-black w-full border rounded-md px-3 py-2">
            ...
            <div>
              ...
              <select {...register('gender')} id="gender" className="form-select text-black w-full border rounded-md px-3 py-2">
          ...
          <div>
            ...
            {errors.categories && <p className="text-red-600 text-sm mt-1">{errors.categories.message as string}</p>}
          </div>
