...
import { getstaticById, updatestatic } from "@/services/staticService";
...
const EditStaticPage = () => {
  ...
  const contentValue = watch("format");
    ...
    <div className="min-h-screen bg-gray-50">
      <header className="bg-white shadow-sm border-b">
        <div className="mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center h-12">
            ...
            <h1 className="text-xl font-medium text-gray-800">Edit Static Page</h1>
          </div>
        </div>
      </header>
      ...
      <main className="mx-auto px-4 sm:px-6 lg:px-8 py-4">
        ...
        >
          ...
          {/* Content Editor */}
          <div>
            <Label htmlFor="format">Content <span className="text-red-600">*</span></Label>
            <SummernoteEditor
              value={contentValue}
