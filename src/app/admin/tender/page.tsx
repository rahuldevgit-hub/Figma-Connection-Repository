...
export default function EmailTemplateList() {
  ...
  const handleCalendarClick = async (id, module) => {
    ...
    try {
      ...
      SwalSuccess('Calendar event created');
    } catch {
      SwalError({ title: "Failed!", message: 'Failed to create calendar event' });
  ...
  const handleSendEmailToEvaluator = async (id) => {
    ...
    try {
      ...
      SwalSuccess('Emails resent to all evaluators successfully');
    } catch {
      SwalError({ title: "Failed!", message: 'Failed to resend emails to evaluators' });
  ...
  const handleInvitationResendEmail = async (id) => {
    ...
    try {
      ...
      SwalSuccess('Emails resent to all suppliers and users successfully');
    } catch {
      SwalError({ title: "Failed!", message: 'Failed to resend invitation emails' });
